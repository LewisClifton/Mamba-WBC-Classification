...
def get(num_classes, pretrained_model_path):
    ...
    if pretrained_model_path is not None:
        ...
        state_dict = torch.hub.load_state_dict_from_url("https://github.com/hunto/LocalMamba/releases/download/v1.0.0/local_vim_tiny.ckpt", model_dir="models/localmamba/pretrained/", file_name='vim_tiny')['model']
