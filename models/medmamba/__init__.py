...
def __build_model(num_classes):
    model_size = 'tiny'
    if model_size == 'tiny':
        return MedMamba(depths=[2, 2, 4, 2], dims=[96,192,384,768], num_classes=6)
    if model_size == 'small':
        return MedMamba(depths=[2, 2, 8, 2], dims=[96,192,384,768], num_classes=6)
    if model_size == 'base':
        return MedMamba(depths=[2, 2, 12, 2], dims=[128,256,512,1024], num_classes=6)
