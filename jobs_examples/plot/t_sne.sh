...
python3 t_sne.py --out_dir="/user/work/js21767/Project/out/t_sne/chula" --dataset_config_path="my_configs/datasets/chula.yml" --dataset_download_dir="/user/work/js21767/Project/"

python3 t_sne.py --out_dir="/user/work/js21767/Project/out/t_sne/bloodmnist" --dataset_config_path="my_configs/datasets/bloodmnist.yml" --dataset_download_dir="/user/work/js21767/Project/"
